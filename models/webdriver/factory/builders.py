...
from models.webdriver.factory.capabilities import build_capabilities
from models.webdriver.factory.options import build_options


def build_chrome(
    version: Union[str, None],
    options: Union[list[str],  None],
    capabilities: Union[dict, None],
    experimental_options: list[dict],
    seleniumwire_options: Union[dict, None],
    extension_paths: Union[list[str], None],
    local_path: Union[str, None],
    webdriver_kwargs: Union[dict,  None],
) -> wire_driver.Chrome:
...
def build_firefox(
    ...
    options: Union[list[str], None],
    capabilities: Union[dict, None],
    experimental_options: Union[list[dict], None],
    seleniumwire_options: Union[dict, None],
    extension_paths: Union[list[str], None],
    local_path: Union[str, None],
    webdriver_kwargs: Union[dict, None],
...
def build_remote(
    ...
    Usage:
        driver = webdriver_factory.build_remote("http://localhost:4444/wd/hub", ["headless"])

    Returns:
        The instance of WebDriver once the connection is successful
    """
    browser = Browser[capabilities['browserName'].upper()]
